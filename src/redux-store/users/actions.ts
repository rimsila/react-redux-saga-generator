...
export const defaultAction = createAction<IUsersState>(DEFAULT_ACTION, () => ({
  errable: { fetchUsersErrorMsg: null },
  booleanable: { isFetchUsersInProgress: true },
  successible: { fetchUsersSuccessMsg: "Successfully initialized!" },
}));
...
export const fetchUsers = createAction<IUsersState>(FETCH_USERS, () => ({
  booleanable: { isFetchUsersInProgress: true, isUpdate: true },
  errable: { fetchUsersErrorMsg: null },
...
export const fetchUsersSuccess = createAction<IUsersState, IUsersState>(
  FETCH_USERS_SUCCESS,
  (state) => ({
    booleanable: { isFetchUsersInProgress: false, isUpdate: false },
